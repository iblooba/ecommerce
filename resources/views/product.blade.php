                ...
                <div class="slide">
                  <div class="imageBox">
                    ...
                    <div class="productImage clearfix">
                      <a href="{{url ('/home/products' ,array($row->ProductID))}}"><img src="{{asset('/assets/img/products')}}/{{ $row->Picture }}" alt="Product Image"></a>
                    </div>
                    <div class="productCaption clearfix text-center">
                      <h3><a href="single-product.html">{{ $row->ProductName }}</a></h3>
                      <span class="offer-price">{{ $row->Price }}</span>

                      <a href="{{url ('/home/orders' ,array($row->ProductID))}}" class="btn btn-border">Buy Now<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
                  </div>
                </div>
