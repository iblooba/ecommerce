...
<?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <div class="slide">
                  <div class="imageBox">
                    ...
                    <div class="productImage clearfix">
                      <a href="<?php echo e(url ('/home/products' ,array($row->ProductID))); ?>"><img src="<?php echo e(asset('/assets/img/products')); ?>/<?php echo e($row->Picture); ?>" alt="Product Image"></a>
                    </div>
                    <div class="productCaption clearfix text-center">
                      <h3><a href="single-product.html"><?php echo e($row->ProductName); ?></a></h3>
                      <span class="offer-price"><?php echo e($row->Price); ?></span>

                      <a href="<?php echo e(url ('/home/orders' ,array($row->ProductID))); ?>" class="btn btn-border">Buy Now<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="imageBox">
                          <div class="productImage clearfix">
                            <a href="single-product.html">
                              <img src="<?php echo e(asset('/assets/img/home/featured-product/product-img7.jpg')); ?>" alt="featured-product-img">
                            </a>
                      ...
                      <div class="col-sm-3 col-xs-12">
                        <div class="imageBox">
                          <div class="productImage clearfix">
                            <a href="single-product.html">
                              <img src="<?php echo e(asset('/assets/img/home/featured-product/product-img8.jpg')); ?>" alt="featured-product-img">
                            </a>
                            <div class="productMasking">
                              <ul class="list-inline btn-group" role="group">
                                <li><a data-toggle="modal" href=".html" class="btn btn-default"><i class="fa fa-heart"></i></a></li>
                      ...
                      <div class="col-sm-3 col-xs-12">
                        <div class="imageBox">
                          <div class="productImage clearfix">
                            <a href="single-product.html">
                              <img src="<?php echo e(asset('/assets/img/home/featured-product/product-img9.jpg')); ?>" alt="featured-product-img">
                            </a>
                            <div class="productMasking">
                              <ul class="list-inline btn-group" role="group">
                                <li><a data-toggle="modal" href=".html" class="btn btn-default"><i class="fa fa-heart"></i></a></li>
          ...
          <div class="modal-body">
            ...
            <div class="media">
              <div class="media-left">
                <img class="media-object" src="<?php echo e(asset('/assets/img/products/quick-view/quick-view-01.jpg')); ?>" alt="Image">
              </div>
