                ...
                <div class="slide">
                  <div class="imageBox">
                    ...
                    <div class="productImage clearfix">
                      <a href="<?php echo e(url ('/home/products' ,array($row->id))); ?>"><img src="<?php echo e(asset('/assets/img/products')); ?>/<?php echo e($row->image); ?>" alt="Product Image"></a>
                    </div>
                    <div class="productCaption clearfix text-center">
                      <h3><a href="single-product.html"><?php echo e($row->name); ?></a></h3>
                      <span class="offer-price"><?php echo e($row->price); ?></span>

                      <a href="<?php echo e(url ('/home/products' ,array($row->id))); ?>" class="btn btn-border">Buy Now<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
                  </div>
                </div>
